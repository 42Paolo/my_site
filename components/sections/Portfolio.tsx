			...
			<div ref={ref} className="max-w-7xl mx-auto px-5 md:px-12 lg:px-16">
				...
				<div className="mb-14">
					...
					<div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
						<motion.h2
							...
							transition={prefersReduced ? { duration: 0 } : { duration: 0.65, delay: 0.08 }}
						...
						<motion.p
							...
							animate={inView ? { opacity: 1, y: 0 } : {}}
							transition={prefersReduced ? { duration: 0 } : { duration: 0.55, delay: 0.18 }}
				...
				{!showAll && (
					<motion.div
						...
						animate={inView ? { opacity: 1, y: 0 } : {}}
						transition={prefersReduced ? { duration: 0 } : { duration: 0.4, delay: 0.3 }}
				...
				<motion.div
					...
					animate={inView ? { opacity: 1, y: 0 } : {}}
					transition={prefersReduced ? { duration: 0 } : { duration: 0.5, delay: 0.7 }}
